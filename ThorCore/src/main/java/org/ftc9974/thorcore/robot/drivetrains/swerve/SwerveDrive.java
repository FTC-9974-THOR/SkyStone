...
public final class SwerveDrive implements HolonomicDrivetrain {
    ...
    public SwerveDrive(HardwareMap hw) {
        ...
        //leftModule.setEncoderOffset(3.292);
        leftModule.setUseQuadEncoder(true);
        leftModule.setEncoderOffset(0.25 * MotorType.YELLOWJACKET_71_2.ticksPerRevolution);
        rightModule.setUseQuadEncoder(true);
        rightModule.setEncoderOffset(0.25 * MotorType.YELLOWJACKET_71_2.ticksPerRevolution);
