...
@Autonomous(name = "Red Foundation Auto")
public class RedFoundationAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        fusion2.drive(this,  new Vector2(-900, 0), this::update, 0.7);
        if (isStopRequested()) return;

        fusion2.drive(this, new Vector2(0, -450), this::update, 0.7);
        if (isStopRequested()) return;
        ...
        fusion2.drive(this, new Vector2(-100, 0), this::update, 1);
        if (isStopRequested()) return;

        fusion2.driveToWallDistance(this, 530, this::update);
        if (isStopRequested()) return;
